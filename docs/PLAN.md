...
| ------------ | -------------------------------------- | ----------------------------------------------------------------------------- |
| Primitives   | Button, Input, Label, Badge, Avatar, TextArea | `asChild` pattern via Radix `Slot` everywhere. Button supports icon children. TextArea added 2026-08-15 — not in the original spec, see dated note below. |
