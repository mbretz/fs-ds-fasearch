  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        sideOffset={4}
        className={cn(
          'z-index-popover min-w-[var(--component-select-input-dropdown-min-width)] overflow-hidden rounded-[var(--component-select-input-border-radius)] border-[length:var(--component-select-input-border-width)] border-[color:var(--component-select-input-border-color-default)] bg-[var(--component-select-input-background-color-default)] shadow-elevation-raised',
          className,
        )}
