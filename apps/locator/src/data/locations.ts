  ...
  },
  {
    ...
    advisors: [
      ...
      },
      {
        ...
        linkedIn: true,
        facebook: false,
        personalInterests: ['hiking', 'live music'],
      },
    ],
    supportStaff: [
      {
  ...
  },
  {
    ...
    advisors: [
      ...
      },
      {
        ...
        linkedIn: true,
        facebook: true,
        personalInterests: ['cooking', 'painting'],
      },
      {
        id: 'adv-25',
        firstName: 'Dakota',
        ...
        designations: ['CPWA®', 'CFP®'],
        tenureYears: 15,
        linkedIn: false,
        facebook: false,
        personalInterests: ['sailing', 'wine tasting', 'reading'],
      },
    ],
    supportStaff: [
      {
  ...
  },
  {
    ...
    advisors: [
      ...
      },
      {
        ...
        linkedIn: true,
        facebook: false,
        personalInterests: ['kayaking', 'golf'],
      },
      {
        id: 'adv-27',
        firstName: 'Frankie',
        ...
        designations: ['ChFC®', 'CLU®'],
        tenureYears: 17,
        linkedIn: true,
        facebook: true,
        personalInterests: ['distance running', 'fishing', 'chess'],
      },
      {
        id: 'adv-28',
        firstName: 'Blake',
        ...
        newClientStatus: 'accepting',
        phone: '(555) 020-0028',
        focusAreas: ['Military and Veterans', 'Investors Nearing Retirement'],
        designations: ['CFA'],
        tenureYears: 6,
        linkedIn: false,
        facebook: false,
        personalInterests: ['skiing', 'community theater'],
      },
      {
        id: 'adv-29',
        firstName: 'Devon',
  ...
  },
  {
    ...
    advisors: [
      ...
      },
      {
        ...
        linkedIn: true,
        facebook: true,
        personalInterests: ['woodworking', 'gardening'],
      },
      {
        id: 'adv-31',
        firstName: 'Peyton',
        ...
        newClientStatus: 'waitlist',
        phone: '(555) 020-0031',
        focusAreas: ['Small Business Retirement Plans', 'Women Investors'],
        designations: ['AAMS™', 'CRPC®'],
        tenureYears: 8,
        linkedIn: true,
        facebook: false,
        personalInterests: ['travel', 'photography'],
      },
      {
        id: 'adv-32',
        firstName: 'Ellis',
        ...
        linkedIn: true,
        facebook: true,
        personalInterests: ['wine tasting', 'sailing'],
      },
      {
        id: 'adv-33',
        firstName: 'Harper',
        ...
        linkedIn: false,
        facebook: false,
        personalInterests: ['fishing', 'skiing', 'chess'],
      },
      {
        id: 'adv-34',
        firstName: 'Micah',
        ...
        linkedIn: true,
        facebook: false,
        personalInterests: ['cooking', 'live music', 'hiking'],
      },
    ],
    supportStaff: [
      {
